...
export const MOOD_CONFIG = {
    happy: {
        songs: [
            ...
            { title: 'Kaatum', artist: 'Salt N Pepper' },
            { title: 'Oru Swapnam Pole', artist: 'Swapnam' },
            { title: 'Kaathu Kaathe', artist: 'Mix' },
            { title: 'Mele Kaavil', artist: 'Mix' },
            { title: 'Eenthola', artist: 'Mix' },
            { title: 'Ethaatha Kombaaneda', artist: 'Mix' },
            { title: 'Lahari Ee Lahari', artist: 'Mix' },
    ...
    surprised: {
        songs: [
            ...
            { title: 'Ethrayo Janmamayi', artist: 'Surprise Remix' },
            { title: 'Kilukil Pambaram', artist: 'Kilukkam' },
            { title: 'Chandanamani Vaathil', artist: 'Electronic' },
            { title: 'Sundari', artist: 'Remix' },
            { title: 'Pavizhamalli', artist: 'Upbeat' },
            { title: 'Karutha Penne', artist: 'Trap Mix' },
            { title: 'Shinkari Melam', artist: 'Electronic' },
            { title: 'Parande', artist: 'Upbeat' },
            { title: 'Oru Maura Mix', artist: 'Fun' },
            { title: 'Chill Chill', artist: 'Electronic' },
            { title: 'Vathikkalu Vellaripravu', artist: 'Upbeat' },
            { title: 'Kalakkatha', artist: 'Ayyappanum Koshiyum' },
            { title: 'Malare', artist: 'Trap' },
            { title: 'Premam BGM', artist: 'Electronic' },
            { title: 'Hey Pillagaada', artist: 'Mix' },
            { title: 'Aalolam', artist: 'Mix' },
            { title: 'Chirakukal', artist: 'Mix' },
            { title: 'Maane', artist: 'Mix' },
            ...
            { title: 'King of Kotha', artist: 'Electronic' },
            { title: 'Band Theme', artist: 'Hridayam' },
            { title: 'Onakka Munthiri', artist: 'Hridayam' },
            { title: 'Darshana', artist: 'Upbeat' },
            { title: 'Manavalan Thug', artist: 'Thallumaala' },
            { title: 'Kaithapoo', artist: 'Mix' },
            { title: 'Vazhiye', artist: 'Mix' },
            { title: 'Uyire', artist: 'Electronic' },
            { title: 'Nee', artist: 'Surprise' },
            { title: 'Pathu Kalpanakal', artist: 'Mix' },
